...
const fullPriceRound = (Math.floor(sodaPrice) + Math.floor(brendyPrice)+ Math.floor(headPhonesPrice)/100)*100;
...
let clientDiscount = Math.floor(Math.random() * (maxDiscount - minDiscount + 1)) + minDiscount;
